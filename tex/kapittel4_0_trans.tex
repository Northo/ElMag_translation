...
{\itsf 1. Explain from the expression of the Lorentz force why magnetic fields (as opposed to electric fields) can not give a charged particle increased kinetic energy.}
...
{\itsf 2. What is the speed of the electron after the acceleration? }
...
{\itsf 4. How much deflection $\Delta y$ does the beam on the screen get if the deflection voltage is \SI{20}{\volt}?}
...
{\itsf 5. Set up in a curve diagram curve intersections over $r$ sfa. $B$ in the range $0 < B < \SI{15}{\gauss}$ for $U_\mathrm{a} = 20$, \num{40} and \SI{60}{\volt}}. Use, for example, Python or Matlab.
...
{\itsf 6. Use the curve cutter that you set up in the problem above to estimate the favorable magnetic field $B$ for three different acceleration voltages $U_\mathrm{a} = 20$, \num{40} and \SI{60}{\volt}.}
...
{\itsf 7. Can you find what disadvantage? }
Catalog \ \
...
{\itsf Connect the acceleration voltage according to figure \ref{lorentz.fig7}}. % og \ref{lorentz.fig7}.}
