...
\begin{itemize}
    ...
    There is a corresponding maximum regulation for voltage-controlled power supply. \SI{30}{\volt} maximum voltage can be given to a resistance of
    \[
      R = U/I = \SI{30}{\volt} / \SI{2.0}{\ampere} = \SI{15}{\ohm}.
    \] At lower resistance, the supply will not be able to provide enough current so that the voltage will drop.
\end{itemize}
